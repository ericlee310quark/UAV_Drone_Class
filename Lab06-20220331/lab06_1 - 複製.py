...
if __name__ == '__main__':
    ...
    x_pid = PID(kP=0.7, kI=0.0001, kD=0.1)  # Use tvec_x (tvec[i,0,0]) ----> control left and right
        ...
        while True: 
            ...
            if markerIds is not None:
                ...
                for i in range(len(markerIds)):
                    ...
                    #print("rvec_zbase: {}".format(rvec_zbase))
                    #print("rvec_zbase shape: {}".format(rvec_zbase.shape))
                ...
                now = time.ctime()
                print("{}: No instructions".format(now))
