...
CORRECT_THRESHOD_X = 20
CORRECT_THRESHOD_Y = 20
...
if __name__ == '__main__':
    ...
    #TODO --->need some modification
    x_pid = PID(kP=0.7, kI=0.00005, kD=0.45)     #0.8, 0.00005, 0.28 # Use tvec_x (tvec[i,0,0]) ----> control left and right
    ...
    try:
        while True: 
            ...
            if markerIds is not None:
                ...
                #print("ele: {}".format(markerIds[0]))
                #print("data type0: {}".format(type(markerIds)))
                #print("data type1: {}".format(type(markerIds[0])))
            ...
            ##########################################################################
                ...
                #print("markerIds: {}".format(markerIds) )
                #target_idex_2 = find_id(markerIds, 0)
                    
                #print("target_idex_2: {}".format(target_idex_2))
                #=======================================
                #       connect to Step 3
                #=======================================
                if(current_state ==0 and is_flying):
                    ...
                    target_idex = find_id(markerIds, 10)    #just test, no use
                    """
                    if target_idex != -1:
                    ...
                    if target_idex_2 != -1:
                        counter_2 += 1
                    if ((counter_2 >= 10) and (target_idex == -1)):
