                    ...
                    if(timer_go):
                        ...
                        if (child_state == 0):
                            ...
                            if(avg_height-100>10):
                                timer_set_2 = (95.0-avg_height)/10.0*TIME_SET_ALAPHA+TIME_SET_BETA
                                drone.send_rc_control(0,0,BASIC_VUD,0)
                                timer_prev, timer_go_2 = timer_count(time.time(), timer_prev, timer_set_2)
                            ...
                            timer_set_2 = 125.0/15.0*TIME_SET_ALAPHA+TIME_SET_BETA
