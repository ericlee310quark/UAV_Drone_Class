                    ...
                    if (timer_enter_first_counter == 0):
                        ...
                        if (child_state == 0):
                            ...
                            if(avg_height-100>10):
                                timer_set = (95.0-avg_height)/BASIC_VUD*TIME_SET_ALAPHA+TIME_SET_BETA
                                drone.send_rc_control(0,0,BASIC_VUD,0)
                                print("down to 105 cm height")
                                timer_prev, timer_go = timer_count(time.time(), timer_prev, timer_set)
                            elif(avg_height-100<-10):
                                timer_set = (avg_height-105.0)/BASIC_VUD*TIME_SET_ALAPHA+TIME_SET_BETA
                            ...
                            if (timer_enter_first_counter == child_state):
                                timer_prev, _ = timer_count(time.time(), timer_prev, 0)
                                timer_enter_first_counter += 1                            
                            timer_set = 100.0/BASIC_VFB*TIME_SET_ALAPHA+TIME_SET_BETA
                ...
                #=======================================
                    ...
                    if (child_state == 0):
                        ...
                        if (timer_enter_first_counter == child_state):
                            timer_prev, _ = timer_count(time.time(), timer_prev, 0)
                            timer_enter_first_counter += 1
                        timer_set = 60.0/float(BASIC_VUD)*TIME_SET_ALAPHA+TIME_SET_BETA
                        drone.send_rc_control(0,0,BASIC_VUD,0)
                        timer_prev, timer_go = timer_count(time.time(), timer_prev, timer_set)
                        if timer_go:
                            drone.send_rc_control(0,0,0,0)
                        ...
                        if (timer_enter_first_counter == child_state):
                            timer_prev, _ = timer_count(time.time(), timer_prev, 0)
                            timer_enter_first_counter += 1
                        timer_set = 90.0/BASIC_VFB*TIME_SET_ALAPHA+TIME_SET_BETA
                        drone.send_rc_control(0,int(BASIC_VFB),0,0)
                        timer_prev, timer_go = timer_count(time.time(), timer_prev, timer_set)
                        if timer_go:
                            drone.send_rc_control(0,0,0,0)
                            child_state = 3        
                        ...
                        if timer_enter_first_counter == child_state:
                            timer_prev, _ = timer_count(time.time(), timer_prev, 0)
                            timer_enter_first_counter += 1
                        timer_set = 60.0/BASIC_VUD*TIME_SET_ALAPHA+TIME_SET_BETA
                        drone.send_rc_control(0,0,int(-1*BASIC_VUD),0)
                        timer_prev, timer_go = timer_count(time.time(), timer_prev, timer_set)
                        if timer_go:
                            drone.send_rc_control(0,0,0,0)
                            child_state = 0
                ...
                #=======================================
                    ...
                    if (child_state == 0):
                        if (timer_enter_first_counter == child_state):
                            timer_prev, _ = timer_count(time.time(), timer_prev, 0)
                            timer_enter_first_counter += 1
                        timer_set = 85.0/BASIC_VFB*TIME_SET_ALAPHA+TIME_SET_BETA
