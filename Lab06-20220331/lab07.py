...
#       State flags
#####################################################################
flag_1st_position = False
flag_2nd_ready = False
flag_2nd_position = False
flag_s_shape_finish = False
...
counter = 0
def correct(frame,markerIds,id):
    for i in range(len(markerIds)):
        ...
        if (markerIds[i]==id):
            ...
            if(tvec[i,0,2]<=80 and tvec[i,0,2]>=60 ):
                counter +=1
                if counter >5000:
                    counter =0
                    if id == 5:
                        global flag_1st_position, flag_2nd_position
                        flag_1st_position = True
                    elif id == 3:
                        flag_2nd_position = True
                    break
            else:
                counter =0
...
if __name__ == '__main__':
    ...
    try:
        while True: 
            ...
            if (flag_1st_position==True and flag_2nd_ready == False):
                drone.move("left",70)
                flag_2nd_ready = True
            elif (flag_2nd_position == True and flag_s_shape_finish == False):
                drone.move("right",70)
                flag_s_shape_finish = True
            else:
                ...
                if markerIds is not None:
                    ...
                    if (flag_1st_position == False):

                        correct(frame,markerIds,5)
                    else:
                        correct(frame,markerIds,3)
